...
{
	partial class Отчет_сотрудники_клиент
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.отчетосотрудникахклиентBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this._Kurs_WORKDataSet3 = new Kurs_Work_BD._Kurs_WORKDataSet3();
			this.отчет_о_сотрудниках_клиентTableAdapter = new Kurs_Work_BD._Kurs_WORKDataSet3TableAdapters.Отчет_о_сотрудниках_клиентTableAdapter();
			this.pictureBox1 = new System.Windows.Forms.PictureBox();
			((System.ComponentModel.ISupportInitialize)(this.bindingSource1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.отчетосотрудникахклиентBindingSource)).BeginInit();
			...
			this.dataGridView1.DataSource = this.отчетосотрудникахклиентBindingSource;
			this.dataGridView1.Location = new System.Drawing.Point(13, 13);
			this.dataGridView1.Name = "dataGridView1";
			this.dataGridView1.RowHeadersWidth = 51;
			this.dataGridView1.RowTemplate.Height = 24;
			this.dataGridView1.Size = new System.Drawing.Size(1335, 464);
			...
			// 
			// отчетосотрудникахклиентBindingSource
			// 
			this.отчетосотрудникахклиентBindingSource.DataMember = "Отчет_о_сотрудниках_клиент";
			this.отчетосотрудникахклиентBindingSource.DataSource = this._Kurs_WORKDataSet3;
			// 
			// _Kurs_WORKDataSet3
			// 
			...
			// 
			// отчет_о_сотрудниках_клиентTableAdapter
			// 
			this.отчет_о_сотрудниках_клиентTableAdapter.ClearBeforeFill = true;
			// 
			// pictureBox1
			// 
			...
			this.pictureBox1.Size = new System.Drawing.Size(1395, 604);
			this.pictureBox1.SizeMode = System.Windows.Forms.PictureBoxSizeMode.StretchImage;
			this.pictureBox1.TabIndex = 32;
			this.pictureBox1.TabStop = false;
			// 
			// Отчет_сотрудники_клиент
			// 
			...
			this.Name = "Отчет_сотрудники_клиент";
			this.Text = "Отчет_сотрудники_клиент";
			this.Load += new System.EventHandler(this.Отчет_сотрудники_клиент_Load);
			((System.ComponentModel.ISupportInitialize)(this.bindingSource1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.dataGridView1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.отчетосотрудникахклиентBindingSource)).EndInit();
		...
		private System.Windows.Forms.BindingSource отчетосотрудникахклиентBindingSource;
		private _Kurs_WORKDataSet3TableAdapters.Отчет_о_сотрудниках_клиентTableAdapter отчет_о_сотрудниках_клиентTableAdapter;
