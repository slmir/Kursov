namespace Kurs_Work_BD
{
	partial class Администратор
	{
		...
		private void InitializeComponent()
		{
			...
			this.b_Entire_Admin = new System.Windows.Forms.Button();
			...
			this.label4.Size = new System.Drawing.Size(594, 39);
			this.label4.TabIndex = 11;
			this.label4.Text = "Войти в систему как администратор";
			// 
			// panel1
			// 
			this.panel1.BackColor = System.Drawing.Color.GreenYellow;
			this.panel1.Controls.Add(this.label3);
			this.panel1.Controls.Add(this.b_Entire_Admin);
			this.panel1.Controls.Add(this.textBoxAdminPass);
			this.panel1.Controls.Add(this.textBoxAdminLogin);
			this.panel1.Controls.Add(this.label2);
			this.panel1.Controls.Add(this.label1);
			this.panel1.Location = new System.Drawing.Point(292, 134);
			...
			// b_Entire_Admin
			// 
			this.b_Entire_Admin.Location = new System.Drawing.Point(243, 142);
			this.b_Entire_Admin.Name = "b_Entire_Admin";
			this.b_Entire_Admin.Size = new System.Drawing.Size(152, 52);
			this.b_Entire_Admin.TabIndex = 4;
			this.b_Entire_Admin.Text = "Войти!";
			this.b_Entire_Admin.UseVisualStyleBackColor = true;
			this.b_Entire_Admin.Click += new System.EventHandler(this.b_Entire_Admin_Click);
			// 
			// textBoxAdminPass
			// 
			this.textBoxAdminPass.Location = new System.Drawing.Point(110, 100);
			this.textBoxAdminPass.Name = "textBoxAdminPass";
			this.textBoxAdminPass.PasswordChar = '*';
			this.textBoxAdminPass.Size = new System.Drawing.Size(285, 22);
			this.textBoxAdminPass.TabIndex = 3;
			// 
			// textBoxAdminLogin
			// 
			this.textBoxAdminLogin.Location = new System.Drawing.Point(110, 70);
			this.textBoxAdminLogin.Name = "textBoxAdminLogin";
			this.textBoxAdminLogin.Size = new System.Drawing.Size(285, 22);
			this.textBoxAdminLogin.TabIndex = 2;
			// 
			// label2
			// 
			...
			// b_exit
			// 
			this.b_exit.Location = new System.Drawing.Point(846, 490);
			...
			// b_back_upravl
			// 
			this.b_back_upravl.Location = new System.Drawing.Point(12, 490);
		...
		private System.Windows.Forms.Button b_Entire_Admin;
